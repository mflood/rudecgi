...
// Created by ParserFactory when content-type of text/xml is detected

#ifndef INCLUDED_SimpleXMLParser_H
#define INCLUDED_SimpleXMLParser_H
...
class SimpleXMLParser: public AbstractParser{

protected:

	char *parseThingy( DataRepos *repository, char *buffer, int length);
